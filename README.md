...
A token is used for user authentication for protected routes. Tokens are saved in local storage, and grant permissions based on the user credentials.

- [ ] What steps can you take in your web apps to keep your data secure?

Using protected/private routes, sending an authentication header with API calls, and tokens can help keep data secure.
